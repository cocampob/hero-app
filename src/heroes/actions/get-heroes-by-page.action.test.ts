...
describe('getHeroesByPageAction', () => {
    ...
    beforeEach(() => {
        heroesApiMock.reset(); //!ESTO SIEMPRE DE DEBE DE HACER LA INSTANCIA PARA QUE ESTE LIMPIA ENTRE PRUEBAS
    })

    test('should return defult heroes', async () => {
    ...
    test('should return the correct heroes when page is not a number', async () => {
        ...
        heroesApiMock.onGet('/').reply(200, responseObjetc);
